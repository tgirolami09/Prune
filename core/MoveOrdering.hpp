...
class HelpOrdering{
    ...
    int captHist[2][2][2][nbPieces+4][nbPieces][64];
    int& getTactIndex(const GameState& state, Move move, bool c, big attacked);
...
public:
    ...
    int getCaptScore(Move move, bool c, const GameState& state, big attacked) const;
    template<int id>
